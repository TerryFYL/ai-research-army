...
| `forensics_report.md` | 数据鉴伪报告（GREEN/YELLOW/RED） |
| `data_dictionary.md` | 265 变量完整字典 |
...
| **Sarah** | 内容获客官 | 痛点内容、渠道运营、转化漏斗 |
| **Tom** | 运营经理 | 定价策略、单位经济学、漏斗管理 |
...
| 数据鉴伪 | `/data-forensics` | 7 项检测 + GREEN/YELLOW/RED |
...
[ARIS](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep) 是另一个优秀的 Claude Code 科研项目，两者互补而非竞争。

| 维度 | ARIS | AI 科研军团 |
|------|------|-----------|
| 领域 | ML/CS（arXiv、GPU） | 医学/临床（NHANES、STROBE） |
| 核心 | 跨模型审稿循环 | 多 Agent 协作 + 叙事驱动 |
| 实验 | GPU 部署 | 数据分析 + 统计检验 |
| 质量 | score >= 6/10 | 8 层审查 + 数字溯源 |
| 产出 | LaTeX | Word 投稿包 |
| 依赖 | Python + LaTeX + GPU | 纯 Markdown，零依赖 |

> 做 ML/CS 推荐 ARIS，做医学/临床/公共卫生试试 AI 科研军团。
...
**一篇论文多少钱？** 200K-500K tokens，Opus 全程约 $3-$8。
...
- [ARIS](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep) — 启发了 Skills 架构

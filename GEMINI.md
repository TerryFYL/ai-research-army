# AI 科研军团 — Gemini CLI 入口

> 本文件是 Gemini CLI 的项目指令，等价于 CLAUDE.md（Claude Code）和 AGENTS.md（Codex CLI）。
...
作为 Gemini，你在军团中的优势角色是：
- **Lena（图表审查）** — 多模态能力，直接看图片审查
- **Jing（文献检索）** — 长上下文处理大量文献
